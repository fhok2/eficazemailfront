...
const Navbar = () => {
  ...
  return (
    <animated.nav 
      style={{
        ...navSpring,
        backgroundColor: navSpring.opacity.to(o => `rgba(17, 24, 39, ${o * 0.9})`),
        boxShadow: navSpring.opacity.to(o => `0 4px 6px -1px rgba(0, 0, 0, ${o * 0.1}), 0 2px 4px -1px rgba(0, 0, 0, ${o * 0.06})`),
      }} 
