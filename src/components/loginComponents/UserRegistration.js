...
const UserRegistration = ({ onBackToLogin, handleGoogleSignInClick, isGoogleLoading }) => {
  ...
  const validatePhone = (phone) => {
    if (phone.length !== 11) {
      ...
      setPhoneError(DDDs.includes(ddd) ? "" : "Hmm, esse DDD não parece familiar. Que tal conferir se digitou corretamente?");
    }
  };
    ...
    <div key={field} className="form-group relative mb-6">
      ...
      <div className="relative">
        <Input
          ...
          onBlur={field === 'phone' ? handlePhoneBlur : () => setFocusedField(null)}
          required
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center px-4 bg-transparent text-white relative z-10 h-full mb-20">
      <animated.div className="w-full max-w-md flex flex-col my-10 z-40 m-auto " style={fadeIn}>
